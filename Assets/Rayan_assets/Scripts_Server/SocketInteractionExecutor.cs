...
public class SocketInteractionExecutor : MonoBehaviour
{
    ...
    {
        Debug.Log("Object inserted into socket: " + args.interactableObject.transform.name);
        onObjectInserted?.Invoke();
    }

    private void OnSelectExited(SelectExitEventArgs args)
    {
        Debug.Log("Object removed from socket: " + args.interactableObject.transform.name);
